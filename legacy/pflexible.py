...
pflexible is now deprecated and will not be further developed
beyond version 0.9.9.

A new package to replace this code is being developed at:

    http://github.com/spectraphilic/reflexible

Instructions for updating your code may be found there.
...
def readgridV9(H, **kwargs):
    ...
    OPS.calcfoot = False
    OPS.verbose = False
    OPS.BinaryFile = True  # XXX using BinaryFile for the time being
    OPS.version = 'V9'
    # # add keyword overides and options to header
    OPS.update(kwargs)
    # H.update(OPS)
    ...
    try:
        ...
        try:
            from jfb.pflexpart.FortFlex import readgrid, sumgrid
            useFortFlex = True
